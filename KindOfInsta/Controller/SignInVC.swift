...
class SignInVC: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {                      // ...a better place for Segue
        ...
        if let _ = KeychainWrapper.standard.string(forKey: KEY_UID) {
            ...
            performSegue(withIdentifier: "goToFeed", sender: nil)       // if there is an uid in keychain then it will do Segue to FeedVC
        }
    }
    ...
    func completeSignIN(id: String, userData: Dictionary<String, String>) {
        ...
        performSegue(withIdentifier: "goToFeed", sender: nil) // it will do Segue to FeedVC if credentials will be ok
    }
